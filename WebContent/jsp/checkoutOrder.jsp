...
<body>
	<div>
			...
			<div class = "row border-bottom mx-3 mb-3 pb-1">
				<div class="d-flex">
					...
					<div class = "ml-3">
						...
						<span>CHF <fmt:formatNumber value="${item.price*item.quantity}" maxFractionDigits="2"/>
		...
		<div class="d-flex justify-content-between pb-5">
			...
			<p class="font-weight-bold">CHF <fmt:formatNumber value="${subTotal}" maxFractionDigits="2" /></p>
		</div>
	</div>
</body>
</html>
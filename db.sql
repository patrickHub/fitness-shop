CREATE DATABASE IF NOT EXISTS fitnessshopdb;
USE fitnessshopdb;
...
CREATE TABLE orderItems(
	...
	CONSTRAINT OrderItem_Product_FK FOREIGN KEY (productID) REFERENCES products(productID)
    
);

INSERT INTO products(productName, productPrice, productDescription, productImgPath)
